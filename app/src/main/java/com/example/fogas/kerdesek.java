...
int pontok = 0;
    ...
    public void kezdes(View view) {
        if(index<20) {
            ...
            String []helyes_valasz = new String[20];
            for(int i =0;i<10;i++){
                helyes_valasz[i]=betuk[i];

            }
            for(int i =10;i<20;i++){
                helyes_valasz[i]=""+(i-10);
            }
            ...
            if(valasz.toString().equals(helyes_valasz[index].toString())){
                pontok = pontok +1;
            }
            TextView teszt=(TextView) findViewById(R.id.textView3);
            //teszt.setText( valasz +" = " + helyes_valasz[index] + " pontok: "+ pontok);

            teszt.setText("!"+valasz + "!=!" + helyes_valasz[index].toString()+"!");
            ...
            kerdes.setText("Enyi helyes valasza volt: " + pontok);
            //kerdes.setText("Vege!");
        }
    }
}